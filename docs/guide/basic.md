...
Which means that in the default configuration, `docs/index.md` and `src/index.md` are only among them 1 will be recognized.
...
export default () => (
  <Previewer sources={{ _: { jsx: "/**\n * debug: true\n */\n\nimport React from 'react';\n\nexport default () => 'I only show in the development environment';" } }} dependencies={{}} debug defaultShowCode>
